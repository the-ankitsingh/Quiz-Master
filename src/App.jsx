    ...
    <div className="bottom">
      ...
      <div className="pyramid">
        <ul className="moneyList">
          {moneyPyramid.map((m)=>(
          <li className={questionNumber === m.id ? "moneyListiItem active":"moneyListiItem"}>
            <span className="moneyListiItemNumber">{m.id}</span>
            <span className="moneyListiItemAmount">{m.amount}</span>
          </li>
          ))}
          </ul>
      </div>
